...
export const PORTFOLIO_SEO: Record<string, { title: string; description: string }> = {
  ...
  "b2b-prospect-research-fintech-software": {
    title: "Fintech B2B Prospect Research",
    description:
  ...
  "cloud-migration-tech-stack-research": {
    title: "Cloud Migration Tech-Stack Research",
    description:
  ...
  "cold-email-ready-list-cybersecurity-msp": {
    title: "Cybersecurity MSP Cold Email List",
    description:
  ...
  "contact-enrichment-uk-consultancy": {
    title: "UK Consultancy Contact Enrichment",
    description:
  ...
  "crm-ready-prospect-database-staffing": {
    title: "Staffing CRM-Ready Prospect Database",
    description:
  ...
  "decision-maker-research-software-reseller": {
    title: "ERP Reseller Decision-Maker Research",
    description:
  ...
  "healthcare-it-decision-maker-research": {
    title: "Healthcare IT Decision-Maker Research",
    description:
  ...
  "msp-prospect-database-us-it-provider": {
    title: "MSP Prospect Database for US IT Provider",
    description:
  ...
  "professional-services-contact-enrichment": {
    title: "Professional Services CRM Enrichment",
    description:
  ...
  "property-management-prospect-list": {
    title: "Property Management Prospect Research",
    description:
  ...
  "recruitment-decision-maker-list": {
    title: "Recruitment Decision-Maker List",
    description:
  ...
  "saas-existing-database-enrichment": {
    title: "SaaS CRM Enrichment and Deduplication",
    description:
  ...
  "saas-lead-generation-uk-analytics-platform": {
    title: "UK Analytics SaaS Prospect Research",
    description:
  ...
  "verified-contact-list-australian-saas": {
    title: "AU and NZ B2B Contact List for SaaS",
    description:
