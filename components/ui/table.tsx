...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={cn("border-t bg-slate-100 dark:bg-slate-800 dark:text-slate-400", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr ref={ref} className={cn("border-b border-slate-200 dark:border-slate-800 transition-colors hover:bg-slate-50/50 dark:hover:bg-slate-900/50", className)} {...props} />
));
